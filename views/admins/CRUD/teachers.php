...
?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= $namespace?>controllers/teacher_controller.php?deletedID=<?= $row['dni']?>" class="btn btn-outline-danger">
...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/teacher_controller.php" method="post">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/teacher_controller.php" method="post" class="">
        <div class="modal-body">
            <div class="form-group">
                <label for="dni">DNI:</label>
