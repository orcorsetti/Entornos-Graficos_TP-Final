  ...
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/admin_controller.php" method="post">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="create-admin" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
...
<?php
    if(isset($_GET['editedID'])){
        ...
        if($conn->errno){
            ...
            header('Location: $namespaceviews/admins/CRUD/administrator.php');
        }
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/admin_controller.php" method="post" class="">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            <button type="submit" name="edit-admin" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
