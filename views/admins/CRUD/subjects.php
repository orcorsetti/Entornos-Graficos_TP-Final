  ...
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/admins/subject_controller.php" method="post">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="age">Año cursado:</label>
                <input type="text" name="age" id="age" class="form-control" required>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            <button type="submit" name="create-subject" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
...
<?php
    if(isset($_GET['editedID'])){
        $id = $_GET['editedID'];
        $query = "SELECT * FROM materias WHERE cod_mat = '$id' ";

        $result = $conn -> query($query);
        if($conn->errno){
            $_SESSION['badRequestError'] = "Error al obtener el recurso";
            header('Location: $namespaceviews/admins/CRUD/subjects.php');
        }
    ...
    <form action="<?= $namespace?>controllers/admins/subject_controller.php" method="post" class="">
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" name="cod_mat" id="cod_mat" class="form-control" value="<?= $user['cod_mat']?>" readonly="readonly" required>
            </div>
            <div class="form-group">
                <label for="name">Nombre:</label>
            ...
            <div class="form-group">
                <label for="age">Año cursado:</label>
                <input type="text" name="age" id="age" class="form-control" value="<?= $user['año_cursado']?>" required>
            </div>
            
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            <button type="submit" name="edit-subject" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
