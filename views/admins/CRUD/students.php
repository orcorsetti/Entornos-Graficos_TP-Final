  ...
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/admins/student_controller.php" method="post">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="create-student" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
...
<?php
    if(isset($_GET['editedID'])){
        ...
        if($conn->errno){
            ...
            header('Location: $namespaceviews/admins/CRUD/students.php');
        }
  ...
  <div class="modal-dialog">
    ...
    <form action="<?= $namespace?>controllers/admins/student_controller.php" method="post" class="">
        <div class="modal-body">
            <div class="form-group">
                <label for="legajo">Legajo:</label>
                <input type="text" name="legajo" id="legajo" class="form-control" value="<?= $user['legajo']?>" readonly="readonly" required>
            </div>
            <div class="form-group">
                <label for="name">Nombre:</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            <button type="submit" name="edit-student" class="btn btn-primary">Guardar</button>
        </div>
      </form>
    </div>
  </div>
